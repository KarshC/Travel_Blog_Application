...
object BlogHttpClient {
    ...
    fun loadBlogArticles(onError: () -> Unit, onSuccess: (List<Data>) -> Unit) {
        ...
        executor.execute {
            kotlin.runCatching {
                ...
                e: Throwable -> Log.e("BlogHttpClient", "Error Loading Blog Articles", e)
                onError()
            }.onSuccess {
                value : List<Data>? -> onSuccess(value ?: emptyList())
            }
        }
    }
}