...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textUsernameLayout.editText?.addTextChangedListener(
            createTextWatcher(
                binding.textUsernameLayout
            )
        )
        binding.textPasswordLayout.editText?.addTextChangedListener(createTextWatcher(binding.textPasswordLayout))
    }

    private fun createTextWatcher(textUsernameLayout: TextInputLayout): TextWatcher? {
    ...
    private fun onLoginClicked() {
        ...
        if (username.isEmpty()) {
            ...
            binding.textPasswordLayout.error = "Password must not be empty"
